...
# It's possible that the GPU does not have enough memory, in such case you can Disable the usage of GPU with this
# Make sure this line is executed before importing TF
'''
import os
...
from Demo.Img2Txt.im2txt.im2txt import configuration, show_and_tell_model
...
class ShowAndTellModelTest(tf.test.TestCase):
    ...
    def _checkOutputs(self, expected_shapes, feed_dict=None):
        ...
        # This was needed in order to get the model to work in Python3
